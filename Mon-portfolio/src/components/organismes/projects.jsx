...
export default function Projects() {
    ...
    <div id="project" >
        ...
        <div className="flex flex-col items-center p-10 bg-primary">
            ...
            <Collapse Repo="https://github.com/Justhiraga/ArgentBank-Frontend" Gpages="" pages="Project-argentBank" technologies={[{ src: javascript_logo, alt: "javascript logo"}, {src: redux_logo, alt:"redux logo"}, {src: postman_logo, alt:"postman logo"},{src: Swagger_logo, alt:"Swagger logo"} ]} />
        </div>
        <div className="flex flex-col items-center text-center p-10 bg-secondary">
        ...
        <div className="flex flex-col items-center p-10 bg-primary">
            ...
            <Collapse Repo="https://github.com/Justhiraga/Appli-Web-React" Gpages="" pages="Project-appreact" technologies={[{ src: react_logo, alt: "react logo"}, {src: CSS3_logo, alt:"css logo"}]} />
        </div>
        <div className="flex flex-col items-center p-10 bg-secondary">
