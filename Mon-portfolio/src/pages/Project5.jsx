            ...
            <div className="min-h-[57vh] flex flex-col items-center pt10 bg-primary">
                ...
                <div className="flex flex-col items-center bg-primary w-full p-20">
                    ...
                    <p className="font-[Roboto] text-white text-[25px] m-6 text-center" >
                        ...
                        - React pour le développement des composants et gestion de l'interface.<br /><br /> 

                        - React Router pour la navigation entre pages.<br /><br /> 

                        - Vite pour l'environnement de développement et build.<br /><br /> 

                        - Node.js pour exécuter JavaScript côté serveur lors du développement.<br /><br /> 

                        - Git et GitHub pour le versionnement du code.<br /><br /> 

                        - Outils de design : maquettes Figma pour le suivi graphique.<br /><br /> 
                ...
                <div className="flex flex-col items-center bg-primary w-full p-20">
                    ...
                    <p className="font-[Roboto] text-white text-[25px] m-6 text-center" >
                        ...
                        - Création et gestion d'une application React multipages.<br /><br /> 

                        - Mise en place du routage dynamique et gestion des paramètres d'URL.<br /><br /> 

                        - Conception de composants fonctionnels et réutilisables (cards, bannière, carrousel, collapse).<br /><br /> 

                        - Gestion des erreurs utilisateur et redirections vers une page d'erreur.<br /><br /> 

                        - Respect strict d'une charte graphique via maquettes.<br /><br /> 

                        - Défis liés à l'interactivité du carrousel et à la gestion des extrémités (navigation).<br /><br /> 
                ...
                <div className="flex flex-col items-center bg-secondary w-full p-20">
                    ...
                    <p className="font-[Roboto] text-white text-[25px] m-6 text-center" >
                        ...
                        - Application React pleinement fonctionnelle, conforme aux attentes du client et aux maquettes.<br /><br /> 

                        - Navigation fluide entre pages, incluant page d'accueil, propriétés, à propos, et page d'erreur.<br /><br /> 

                        - Composants interactifs comme carrousel et collapse intégrés avec animations.<br /><br /> 

                        - Code du projet versionné sur GitHub, prêt à être présenté.<br /><br /> 

                        - Mise en place d'un environnement stable via Vite.<br /><br /> 

                        - Respect des critères de qualité fonctionnelle et visuelle.<br /><br /> 
                    </p>
                </div>
                <div className="flex flex-col items-center bg-primary w-full p-20">
                    ...
                    <p className="font-[Roboto] text-white text-[25px] m-6 text-center" >
                        ...
                        - Ajouter une connexion à un back-end réel pour récupérer les données en dynamique.<br /><br /> 

                        - Optimiser les performances (lazy loading des composants, optimisation des images).<br /><br /> 

                        - Ajouter des tests unitaires et d'intégration pour garantir la robustesse.<br /><br /> 

                        - Améliorer l'accessibilité (a11y) et la responsivité sur tous types d'appareils.<br /><br /> 

                        - Enrichir les animations et transitions pour une meilleure expérience utilisateur.<br /><br /> 
